...
<p align="center">
  <b>TabTrim</b> 是一款轻量级 Chrome 扩展（< 100 KB），专为「标签页重度用户」设计。<br>
  去重、休眠、内存监控、历史恢复，一个插件全搞定。<br>
  <b>纯原生 JS，零框架依赖，无需任何构建步骤，下载即用。</b>
</p>
...
> 你是否有过这些困扰：
> - 同一个 GitHub 页面开了 5 个，却不知道哪个是最新的？
> - 几十个标签页挤在一起，内存占用飙升，电脑风扇狂转？
> - 不小心关掉了一个重要页面，再也找不回来？

**TabTrim 就是为解决这些问题而生的。**
